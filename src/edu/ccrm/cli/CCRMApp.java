...
public class CCRMApp {
    ...
    void run() {
        ...
        mainLoop:
        while (true) { // while loop plus labeled jump demonstration
            showMainMenu();
...
>""");
    ...
    void addStudent() {
        ...
        studentService.add(id, reg, name, email, status); // overloaded service method
...
>""");
    ...
    void updateCourse() {
        ...
        courseService.byCode(code).ifPresentOrElse(course -> {
            System.out.print("new title (blank to keep): ");
            String title = sc.nextLine();
            if (!title.isBlank()) course.setTitle(title);

            System.out.print("new instructor (blank to keep): ");
            String instructor = sc.nextLine();
            if (!instructor.isBlank()) course.setInstructor(instructor);

            System.out.print("new department (blank to keep): ");
            String department = sc.nextLine();
            if (!department.isBlank()) course.setDepartment(department);
    ...
    void deactivateCourse() {
        ...
        courseService.byCode(code).ifPresentOrElse(course -> {
            ...
            System.out.println("Deactivated " + course.getCode());
        }, () -> System.out.println("Course not found."));
    }
...
>""");
    ...
    void backupMenu() {
        ...
        try {
            ...
            System.out.println("Backup command finished.");
        }
    }
